--[[
PARA USAR ESSE SCRIPT ACESSE A PASTA 
(C:\Users\pablo\AppData\Roaming\OTClientV8\Globalzudo\bot\SUACONFIGURACAO)
OU
APERTE CTRL+R DIGITE %APPDATA% APERTE ENTER, PROCURE A PASTA ROAMING SE JÁ NÃO ESTIVER NELA E SIGA O RESTO
DENTRO DESSA PASTA CRIE UM ARQUIVO COM O NOME QUE QUISER POR EXEMPLO:
z_followPlayer.lua
A EXTENSÃO PRECISA SER .lua
--]]
...
FloorChangers = {
    Ladders = {
        Up = {1948, 5542, 16693, 16692, 8065, 8263, 14},
        Down = {432, 412, 469, 1949, 469}
    },

    Holes = {
        Up = {},
        Down = {293, 294, 595, 4728, 385, 9853, 26140}
    },
    ...
    Stairs = {
        Up = {16690, 1958, 7548, 7544, 1952, 1950, 1947, 7542, 855, 856, 1978, 1977, 6911, 6915, 1954, 5259, 20492, 1956, 1957, 1955, 5257, 5258, 775, 25058, 22566, 22747, 30757, 20225},
...
UI.Label("Follow Player:"):setColor("black")
...
macro(700, "Advanced Follow", "", function(macro)
    local c = getCreatureByName(target)
